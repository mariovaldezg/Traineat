...
import { LayoutDashboard, Calendar, Dumbbell, Apple, Scale, TrendingUp, Zap } from 'lucide-react'
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-100 flex flex-col">
      <div className="p-5 border-b border-gray-100">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="font-semibold text-sm">Waco 70.3</span>
        </div>
        <p className="text-xs text-gray-400">Mario · Oct 4, 2026</p>
