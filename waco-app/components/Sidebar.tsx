  ...
  return (
        <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-100 flex flex-col">
              <div className="p-5 border-b border-gray-100">
                      ...
                      <p className="text-xs text-gray-400 text-center">Mario · Waco 70.3 · Oct 4, 2026</p>p>
                      <div className="mt-3 bg-teal-light rounded-lg px-3 py-2">
                                <p className="text-2xl font-semibold text-teal">{daysLeft}</p>p>
                                <p className="text-xs text-teal-dark">días para la carrera</p>p>
                      </div>div>
              </div>div>
              ...
              <div className="p-4 border-t border-gray-100">
                      <div className="text-xs text-gray-400 text-center">Meta: Sub 5:30 🏁</div>div>
              </div>div>
        </aside>aside>
      )
}</aside>
